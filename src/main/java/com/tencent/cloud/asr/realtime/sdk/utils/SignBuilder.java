...
public class SignBuilder {
	 ...
	 *            请求秘钥
	 */
	public static String createPostSign(String serverUrl, String secretKey) {
		return createSign(serverUrl, secretKey, "POST");
	}
	 ...
	 *            请求秘钥
	 */
	public static String createGetSign(String serverUrl, String secretKey) {
		return createSign(serverUrl, secretKey, "GET");
	}
	 ...
	 *            请求类型，必须是：GET或 POST
	 */
	public static String createSign(String serverUrl, String secretKey, String requestType) {
		validateRequestType(requestType);
		int position = serverUrl.toLowerCase().startsWith("https://") ? 8 : 7;
		String strToBeEncoded = requestType + serverUrl.substring(position);
	 ...
	 *            请求类型，必须是：GET或 POST
	 */
	public static String createSignAndUrlEncode(String serverUrl, String secretKey, String requestType) {
		validateRequestType(requestType);
		String sign = createSign(serverUrl, secretKey, requestType);
		try {
